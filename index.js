...
menuItems.forEach(item => {
    item.addEventListener('click', () => {
        ...
        if (item.id != 'notifications') {
            ...
            document.querySelector('#notifications .notifications__count').style.display = 'none';
        }
    });
});
...
messagesNotification.addEventListener('click', () => {
    ...
    messagesNotification.querySelector('.notifications__count').style.display = 'none';
    setTimeout(() => {
